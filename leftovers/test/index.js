...
new Vue({
  ...
  template: `
    <f-scene-data2 size="500">
      <f-buffer slot-scope="data" length="200" :map="() => [0,0]">
        ...
        >
          <f-circle
            ...
            :fill="hsl(i * 10)"
          />
          <f-box @mousemove.native="data2.update([data.x,data.y])" stroke-width="0.01" fill="rgba(0,0,0,0)" width="10" height="10" />
        </f-group>
      </f-buffer>
    </f-scene-data2>
  `
...
//   template: `
//     <f-scene-data2 size="500">
//       <f-buffer slot-scope="scenedata" length="10" :map="() => [0,0]">
//         <f-group
//           slot-scope="bufferdata"
//           @mousemove.native="bufferdata.update([scenedata.x,scenedata.y])"
//         >
//           <f-circle
//             v-for="(p,i) in bufferdata.value"
//             :x="p[0]"
//             :y="p[1]"
//             r="0.5"
//             stroke-width="0.1"
